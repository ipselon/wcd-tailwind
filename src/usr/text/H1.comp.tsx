 ...
 */
const H1 = ({ tailwindUtilities, children, text, globalAttrs}: SectionOrTextProps) => (
    <HtmlElement tag="h1" tailwindUtilities={tailwindUtilities} {...pickWithValues(globalAttrs)}>
