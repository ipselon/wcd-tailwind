 ...
 */
const H6 = ({ tailwindUtilities, children, text, globalAttrs }: SectionOrTextProps) => (
    <HtmlElement tag="h6" tailwindUtilities={tailwindUtilities} {...pickWithValues(globalAttrs)}>
