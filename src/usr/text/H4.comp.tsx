 ...
 */
const H4 = ({ tailwindUtilities, children, text, globalAttrs }: SectionOrTextProps) => (
    <HtmlElement tag="h4" tailwindUtilities={tailwindUtilities} {...pickWithValues(globalAttrs)}>
