 ...
 */
const H3 = ({ tailwindUtilities, children, text, globalAttrs }: SectionOrTextProps) => (
    <HtmlElement tag="h3" tailwindUtilities={tailwindUtilities} {...pickWithValues(globalAttrs)}>
