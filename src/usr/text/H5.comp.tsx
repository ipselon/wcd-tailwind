 ...
 */
const H5 = ({ tailwindUtilities, children, text, globalAttrs }: SectionOrTextProps) => (
    <HtmlElement tag="h5" tailwindUtilities={tailwindUtilities} {...pickWithValues(globalAttrs)}>
