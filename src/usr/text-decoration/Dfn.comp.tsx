 ...
 */
const Dfn = ({ tailwindUtilities, children, text, globalAttrs }: SectionOrTextProps) => (
    <HtmlElement tag="dfn" tailwindUtilities={tailwindUtilities} {...pickWithValues(globalAttrs)}>
