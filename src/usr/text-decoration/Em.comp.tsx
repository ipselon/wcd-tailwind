 ...
 */
const Em = ({ tailwindUtilities, children, text, globalAttrs }: SectionOrTextProps) => (
    <HtmlElement tag="em" tailwindUtilities={tailwindUtilities} {...pickWithValues(globalAttrs)}>
