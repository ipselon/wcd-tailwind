 ...
 */
const Bdo = ({ tailwindUtilities, children, text, globalAttrs }: SectionOrTextProps) => (
    <HtmlElement tag="bdo" tailwindUtilities={tailwindUtilities} {...pickWithValues(globalAttrs)}>
